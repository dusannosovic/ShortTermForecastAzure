...
namespace DataExtractor
{
    ...
    /// </summary>
    internal sealed class DataExtractor : StatelessService
    {
        public DataExtractor(StatelessServiceContext context)
            : base(context)
        { }
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            return new List<ServiceInstanceListener>(1) {
                 new ServiceInstanceListener(context => this.CreateInternalListener(context))
             };
        }
        private ICommunicationListener CreateInternalListener(StatelessServiceContext context)
        {
            ...
            var listener = new WcfCommunicationListener<IDataExtractorService>(
                serviceContext: context,
                wcfServiceObject: new DataExtractorService(),
